...
{
    public class DetailedWorklistItem
    {
        ...
        internal DetailedWorklistItem(string connectionString, string connectionStringImpersonate)
        {
        ...
        {
            ServiceObject so = new ServiceObject("DetailedWorklistItem");
